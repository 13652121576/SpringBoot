...
public class SysRolePowerController {
	 ...
	 public SysRolePower getById(@PathVariable String id) {
	 ...
	 public List<SysRolePower> getList(@RequestBody(required=false) Map<String,Object> paramMap) {
